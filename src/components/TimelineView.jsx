  ...
  const events = [
    {
      ...
      description: 'Daniel Santos teaches 6th-grade Social Studies at Jackson Middle School with consistently high classroom observation ratings.',
      type: 'structural'
    },
    {
      date: 'Summer 2012',
      ...
      description: 'HISD mandates 50% EVAAS value-added weighting in teacher evaluations and ties scores directly to contract non-renewal.',
      type: 'governance'
    },
    {
      date: 'Spring 2013',
      ...
      description: 'Administered norm-referenced test where STAAR was unavailable. Alleged mismatch with TEKS social studies curriculum.',
      type: 'pipeline'
    },
    {
      date: 'June 2013',
      ...
      description: 'HISD extracts student testing histories and roster links, transmitting files to SAS Institute servers in North Carolina.',
      type: 'pipeline'
    },
    {
      date: 'Summer 2013',
      ...
      description: 'Proprietary algorithm computes teacher value-added gain scores; outputs Santos Teacher Growth Index at -2.1 ("Least Effective").',
      type: 'pipeline'
    },
    {
      date: 'Fall 2013',
      ...
      description: 'HISD accepts scores without independent replication or audit and integrates -2.1 index into Santos annual performance rating.',
      type: 'alert'
    },
    {
      date: 'October 2013',
      ...
      description: 'Jackson MS / HISD places Santos on formal disciplinary Growth Plan, creating formal administrative basis for non-renewal.',
      type: 'alert'
    },
    {
      date: 'Nov 13, 2013',
      ...
      description: 'HFT requests underlying source code, formulas, and Santos student linkage records to verify evaluation accuracy.',
      type: 'governance'
    },
    {
      date: 'Winter 2013',
      ...
      description: 'HISD refuses to provide source code and calculation rules, asserting SAS proprietary intellectual property protections.',
      type: 'alert'
    },
    {
      date: 'May 2014',
      ...
      description: 'Federal complaint filed under 42 U.S.C. § 1983 alleging 14th Amendment Procedural Due Process deprivations.',
      type: 'structural'
    },
    {
      date: 'May 4, 2017',
      ...
      description: 'Federal court rules HISD evaluation system violated Due Process: unreplicable algorithmic scores cannot deprive teachers of employment.',
      type: 'governance'
    }
  ];
    ...
    <div className="view-container timeline-view-container">
      <div className="view-header">
        <div>
          ...
          <p className="view-sub">From curriculum mismatch to federal civil rights summary judgment</p>
        </div>
