    ...
    <section className="sequence-bar">
      <div className="sequence-header-inline">
        ...
        <div className="sequence-scroll-btns">
          <button className="seq-nav-btn" onClick={scrollLeft} title="Scroll Left">
            <Icon name="chevron-left" size={13} />
          </button>
          <button className="seq-nav-btn" onClick={scrollRight} title="Scroll Right">
            ...
            <React.Fragment key={item.step}>
              ...
              >
                ...
                <span className="seq-icon-pill">
                  <Icon name={item.nodeId.includes('alert') || item.nodeId.includes('score') ? 'alert' : 'action'} size={12} />
                </span>
