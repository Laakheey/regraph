...
export const RunDetailsModal = ({ node, isOpen, onClose }) => {
  ...
  const auditSteps = [
    {
      ...
      status: "VERIFIED",
      detail:
        "Extracted student testing records from HISD Student Information System (SIS); transferred to SAS secure FTP server.",
    },
    {
      step: 2,
      ...
      detail:
        "Teacher Santos listed for 6th-grade Social Studies; 42 students linked. Pleading notes incomplete roster verification disputes.",
    },
    {
      step: 3,
      ...
      detail:
        "SAS EVAAS engine executed proprietary statistical equations. Covariance matrices and regression coefficients withheld as proprietary.",
    },
    {
      step: 4,
      ...
      detail:
        'Standardized Gain Score computed as -2.1 (Standard Error: 0.82). Metric automatically categorized as "Least Effective".',
    },
    {
      step: 5,
      ...
      detail:
        "HISD applied 50% EVAAS weight under Board Policy DFBB (Local). Prescriptive Growth Plan issued without administrative audit.",
    },
  ];
  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div
        className="modal-dialog run-details-modal"
      ...
      >
        ...
        <div className="modal-body">
          ...
          <div className="modal-card">
            ...
            <div className="audit-meta-grid">
              ...
              <div className="meta-cell">
                ...
                <span className="meta-value">
                  {node.date || "2012–2013 School Year"}
                </span>
              </div>
              <div className="meta-cell">
                <span className="meta-label">Human Checkpoint:</span>
                <span className="meta-value alert-text">
                  {node.humanCheckpoint || "None Detected"}
                </span>
              </div>
            </div>
          </div>
                ...
                <div key={s.step} className="audit-step-item">
                  ...
                  <div className="step-content">
                    <div className="step-header">
                      <b>{s.name}</b>
                      <span className="step-timestamp font-mono">
                        {s.timestamp}
                      </span>
                    </div>
          ...
          <div className="modal-card">
            <h4 className="card-title">
              <Icon name="model" size={14} /> Raw Model Outputs & Algorithmic
              Parameters
            </h4>
...
Independent Audit Verification  : FAILED / NOT PERFORMED`}
          ...
          <div className="modal-card">
            <h4 className="card-title">
              <Icon name="assessment" size={14} /> Evidentiary Citations & Case
              Excerpts
            </h4>
            <div className="citations-list">
              <div className="citation-item">
                <span className="citation-source">
                  Plaintiffs' Complaint pp. 21–24:
                </span>
                <p>
                  "HISD does not possess the proprietary software programs or
                  equations necessary to verify or replicate the EVAAS scores.
                  When teachers requested their underlying data and formulas to
                  challenge erroneous scores, HISD responded that the
                  information was a trade secret owned exclusively by SAS."
                </p>
              </div>
              <div className="citation-item">
                <span className="citation-source">
                  HFT v. HISD, 251 F. Supp. 3d 1168, 1177 (S.D. Tex. 2017)
                  (Gilmore, J.):
                </span>
                <p>
                  "When a teacher's continued employment is at stake, the
                  Fourteenth Amendment's guarantee of procedural due process
                  requires that the teacher be provided a meaningful opportunity
                  to challenge the accuracy of the performance evaluation.
                  High-stakes employment decisions cannot be based on an
                  unexaminable algorithmic black box."
                </p>
              </div>
              <div className="citation-item">
                <span className="citation-source">
                  Texas Public Information Act (TPIA) Demand:
                </span>
                <p>
                  Formal demand filed November 13, 2013 by Houston Federation of
                  Teachers seeking SAS EVAAS algorithms, coefficient matrices,
                  and Santos student linkage records. Denied under proprietary
                  exemption.
                </p>
              </div>
            </div>
