  ...
  "hft-santos": {
    ...
    nodes: [
      // ==================== COLUMN 4: Daniel Santos (above Score) ====================
      {
        ...
        trace: {
          responsibility: {
            text: "Affected person / Educator",
            status: "Attributed",
          },
          authority: {
            text: "Texas Educator Certificate",
            status: "Supported",
          },
          control: {
            text: "No control over algorithmic metrics",
            status: "Tracked",
          },
          evidence: {
            text: "Complaint pp. 2, 16, 21, 23–24",
            status: "Supported",
          },
        },
      },
      {
        ...
        trace: {
          ...
          authority: {
            text: "HISD Administrative Hierarchy",
            status: "Supported",
          },
          control: {
            text: "Subject to District-wide appraisal policy",
            status: "Tracked",
          },
      ...
      },
      {
        ...
        trace: {
          responsibility: {
            text: "Evidence / challenge actor",
            status: "Attributed",
          },
          authority: {
            text: "Requesting party under TPIA",
            status: "Supported",
          },
      ...
      // ==================== COLUMN 2: Governance & Contracts (x: 375) ====================
      {
        ...
        objective:
          "Adopted EVAAS 50% weight for teacher appraisal and contract decisions",
        ...
        trace: {
          responsibility: {
            text: "HISD Central Administration & Board",
            status: "Attributed",
          },
          authority: {
            text: "Texas Education Code & Local Policy",
            status: "Supported",
          },
          control: {
            text: "Data supply, contract adoption & employment use",
            status: "Tracked",
          },
      ...
      },
      {
        ...
        trace: {
          responsibility: {
            text: "Technical output candidate",
            status: "Attributed",
          },
          authority: {
            text: "Commercial vendor contract (Not employment authority)",
            status: "Supported",
          },
          control: {
            text: "Controlled statistical generation process",
            status: "Tracked",
          },
      ...
      // ==================== COLUMN 3: Inputs & Algorithmic Engines (x: 690) ====================
      {
        ...
        trace: {
          responsibility: {
            text: "HISD Assessment Selection",
            status: "Attributed",
          },
          authority: {
            text: "District assessment policy",
            status: "Supported",
          },
          control: {
            text: "Alignment to taught TEKS unresolved",
            status: "Unresolved",
          },
      ...
      },
      {
        ...
        objective:
          "Input dataset transmitted to SAS for statistical computation",
        date: "June 2013",
        status: "Transmitted",
        ...
        trace: {
          responsibility: {
            text: "HISD Data Management",
            status: "Attributed",
          },
          authority: { text: "Data sharing agreement", status: "Supported" },
          control: {
            text: "Exact student-level inputs withheld from teacher",
            status: "Tracked",
          },
      ...
      },
      {
        ...
        objective:
          "Estimate teacher value-added effect using multivariate model",
        date: "2012–2013 Run",
        ...
        trace: {
          responsibility: {
            text: "Mathematical model system (Not a legal person)",
            status: "Attributed",
          },
          authority: {
            text: "None independently established",
            status: "Unresolved",
          },
          control: {
            text: "Proprietary methodology withheld",
            status: "Tracked",
          },
          evidence: {
            text: "Method execution details unavailable",
            status: "Supported",
          },
        },
      },
      ...
      // ==================== COLUMN 4: Outputs & Consequences (x: 1005) ====================
      {
        ...
        trace: {
          responsibility: {
            text: "Algorithmic output attributed to Santos",
            status: "Attributed",
          },
          authority: {
            text: "Used as basis for employment consequence",
            status: "Supported",
          },
          control: {
            text: "Santos-specific calculation unavailable to review",
            status: "Tracked",
          },
          evidence: {
            text: "Direct score report not attached in complaint",
            status: "Supported",
          },
        },
      },
      {
        ...
        trace: {
          responsibility: {
            text: "Institutional consequence candidate",
            status: "Attributed",
          },
          authority: { text: "HISD appraisal framework", status: "Supported" },
          control: {
            text: "Consequential use of algorithmic output",
            status: "Tracked",
          },
      ...
      },
      {
        ...
        objective:
          "Impose prescriptive corrective plan; precursor to non-renewal",
        date: "October 2013",
        ...
        trace: {
          responsibility: {
            text: "Consequential action candidate",
            status: "Attributed",
          },
          authority: {
            text: "Individual issuer not identified",
            status: "Unresolved",
          },
          control: {
            text: "Formal approval capacity unresolved",
            status: "Tracked",
          },
          evidence: {
            text: "Individual human actor missing in complaint",
            status: "Supported",
          },
        },
      },
      {
        ...
        trace: {
          responsibility: {
            text: "Evidence gap candidate",
            status: "Attributed",
          },
          authority: {
            text: "Scope of HISD access unresolved",
            status: "Unresolved",
          },
          control: {
            text: "SAS proprietary control alleged",
            status: "Tracked",
          },
          evidence: {
            text: "Partially supported; exact scope unresolved",
            status: "Supported",
          },
        },
      },
      ...
      // ==================== RESPONSIBILITY GAPS (Bottom Center) ====================
      {
        ...
        trace: {
          responsibility: {
            text: "Unresolved — do not attribute to named person",
            status: "Unresolved",
          },
          authority: {
            text: "Unresolved in source record",
            status: "Unresolved",
          },
          control: {
            text: "Review / refusal capacity unresolved",
            status: "Unresolved",
          },
          evidence: {
            text: "Requires records, communications, or testimony",
            status: "Supported",
          },
        },
      },
    ...
    links: [
      ...
      { from: "evaas", to: "score", label: "GENERATED", category: "pipeline" },
      {
        from: "score",
        to: "santos",
        label: "REPORTED RESULT FOR",
        category: "pipeline",
      },
      {
        from: "score",
        to: "evaluation",
        label: "USED IN EVALUATION",
        category: "pipeline",
      },
      ...
      { from: "hft", to: "hisd", label: "REQUESTED FROM", category: "alert" },
      {
        from: "hisd",
        to: "disclosure",
        label: "PARTIAL / WITHHELD",
        category: "alert",
      },
      {
        from: "hft",
        to: "disclosure",
        label: "SOUGHT RECORDS",
        category: "alert",
      },
    ...
    sequence: [
      ...
      {
        step: 2,
        title: "Assessment Input Mismatch",
        time: "Complaint pp. 9, 23",
        nodeId: "assessment",
        icon: "wrench",
      },
      {
        step: 3,
        title: "Data Provided to SAS",
        time: "Complaint pp. 21–22",
        nodeId: "student-data",
        icon: "cube",
      },
      {
        step: 4,
        title: "SAS EVAAS Analysis",
        time: "Complaint pp. 13–15",
        nodeId: "evaas",
        icon: "server",
      },
      {
        step: 5,
        title: "Score Reported (Least Effective)",
        time: "Complaint p. 24",
        nodeId: "score",
        icon: "bell",
        isAlert: true,
      ...
      {
        step: 6,
        title: "HISD Appraisal Imposition",
        time: "Complaint pp. 15–16",
        nodeId: "evaluation",
        icon: "action",
      },
      {
        step: 7,
        title: "Growth Plan Placed on Santos",
        time: "Fall 2013",
        nodeId: "plan",
        icon: "governance",
      },
      {
        step: 8,
        title: "TPIA Request & Withheld Code",
        time: "Nov 13, 2013",
        nodeId: "disclosure",
        icon: "resource",
      },
